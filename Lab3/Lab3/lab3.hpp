...
public:
    Lab3(const std::string& kernelCodeFileName, const std::string& kernelFunctionName) {
    ...
    void cpuSolve() {
        ...
        std::cout << __FUNCTION__ << " Odd numbers found: " << oddNumbers << "\n";
    }
...
private:
    Lab3(const Lab3& other) {}
    Lab3& operator=(const Lab3& other) {}
    Lab3(Lab3&& other) noexcept {}
    Lab3& operator=(const Lab3&& other) noexcept {}
};
